...
subjectID - Range from 1 to 30, each corresponds to a test subject. They were originallly divided into two groups (test and train) but is combined into one dataset in this project

activity - labels the six different activities recorded for the origianl dataset - 
1 WALKING
2 WALKING_UPSTAIRS
...
The below are variables in the dataset. 
